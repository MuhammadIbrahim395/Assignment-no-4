...
function positiveInteger(integer) {
...
positiveInteger(4);
/*function num2(positiveInteger:number){
    let integer1:number=0;
    if(positiveInteger >=0){
 console.log("yes you wright a right integer" );

}
else {
    console.log("please wright a posiive ineger")
    
 }
 let i:number=positiveInteger
 while(i>0){
     i--
     let integer2:number=positiveInteger;
     let integer3:number=integer2*i
    
     // integer3+=integer3
     integer1= integer1+integer3
    }
